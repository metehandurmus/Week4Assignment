package dev.patika.week4assignment.configuration;

import dev.patika.week4assignment.entity.*;
import dev.patika.week4assignment.repository.*;
...
public class GeneralConfiguration {
    ...
    private void CreateDatasByPostConstruct() {
        ...
        expedition1.setExpeditionDate(new Date(2023, 6, 23, 17, 20));
        ...
        expedition2.setExpeditionDate(new Date(2023, 6, 23, 17, 40));
        ...
        expedition3.setExpeditionDate(new Date(2023, 6, 23, 17, 20));
        ...
        expedition4.setExpeditionDate(new Date(2023, 6, 23, 17, 40));
